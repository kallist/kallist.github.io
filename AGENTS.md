...
- This is the `kallist` public, static personal portfolio; the resume retains Wei Zhuojie's real identity. Next.js exports to `out/` for GitHub Pages. Keep all core behavior compatible with static hosting; no server API, database or browser GitHub API calls.

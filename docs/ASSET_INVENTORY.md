...
| `public/portrait/self-portrait.webp` | Encoded from supplied original with Pillow WebP quality 95, same 1448×1086 pixels | Browser asset used in hero and visual section; reduced from 3.59 MB to 0.83 MB without composition changes |
